...
A practical quick-reference for the most commonly used macOS terminal commands, organized by category for fast lookup. Default shell on modern macOS is **zsh**.
