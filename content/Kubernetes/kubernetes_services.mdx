...
tags: [kubernetes, metallb, microk8s, k8s, container, pod, service, port-forward, nodeport, loadbalancer, clusterip, externalname, headless]
---
  ...
  <CardContent className="pt-6">
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="w-full max-w-md bg-blue-100 dark:bg-blue-900 border-2 border-blue-400 rounded-lg p-4 text-center">
        <div className="font-bold text-blue-800 dark:text-blue-200">External Client</div>
        <code className="text-sm text-blue-600 dark:text-blue-300">http://NodeIP:30080</code>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <div className="bg-orange-100 dark:bg-orange-900 border-2 border-orange-400 rounded-lg p-3 text-center min-w-24">
          <div className="font-semibold text-orange-800 dark:text-orange-200">Node 1</div>
          <code className="text-xs text-orange-600 dark:text-orange-300">:30080</code>
        </div>
        <div className="bg-orange-100 dark:bg-orange-900 border-2 border-orange-400 rounded-lg p-3 text-center min-w-24">
          <div className="font-semibold text-orange-800 dark:text-orange-200">Node 2</div>
          <code className="text-xs text-orange-600 dark:text-orange-300">:30080</code>
        </div>
        <div className="bg-orange-100 dark:bg-orange-900 border-2 border-orange-400 rounded-lg p-3 text-center min-w-24">
          <div className="font-semibold text-orange-800 dark:text-orange-200">Node 3</div>
          <code className="text-xs text-orange-600 dark:text-orange-300">:30080</code>
        </div>
      </div>
      ...
      <div className="bg-purple-100 dark:bg-purple-900 border-2 border-purple-400 rounded-lg p-4 text-center">
        <div className="font-bold text-purple-800 dark:text-purple-200">Service (ClusterIP)</div>
        <code className="text-sm text-purple-600 dark:text-purple-300">:80</code>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-3">
        <div className="bg-green-100 dark:bg-green-900 border-2 border-green-400 rounded-lg p-3 text-center min-w-20">
          <div className="font-semibold text-green-800 dark:text-green-200">Pod 1</div>
          <code className="text-xs text-green-600 dark:text-green-300">:80</code>
        </div>
        <div className="bg-green-100 dark:bg-green-900 border-2 border-green-400 rounded-lg p-3 text-center min-w-20">
          <div className="font-semibold text-green-800 dark:text-green-200">Pod 2</div>
          <code className="text-xs text-green-600 dark:text-green-300">:80</code>
        </div>
        <div className="bg-green-100 dark:bg-green-900 border-2 border-green-400 rounded-lg p-3 text-center min-w-20">
          <div className="font-semibold text-green-800 dark:text-green-200">Pod 3</div>
          <code className="text-xs text-green-600 dark:text-green-300">:80</code>
        </div>
      </div>
    </div>
...
<Card className="bg-slate-50 dark:bg-slate-900 border-2">
  <CardContent className="pt-6">
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="w-full max-w-md bg-blue-100 dark:bg-blue-900 border-2 border-blue-400 rounded-lg p-4 text-center">
        <div className="font-bold text-blue-800 dark:text-blue-200">External Client</div>
        <code className="text-sm text-blue-600 dark:text-blue-300">http://192.168.1.240:27017</code>
      </div>
      ...
      <div className="bg-cyan-100 dark:bg-cyan-900 border-2 border-cyan-500 rounded-lg p-4 text-center shadow-lg">
        <div className="font-bold text-cyan-800 dark:text-cyan-200">LoadBalancer</div>
        <div className="text-sm text-cyan-700 dark:text-cyan-300">External IP</div>
        <code className="text-sm font-mono text-cyan-600 dark:text-cyan-300">192.168.1.240</code>
      </div>
...
<Alert variant="warning">
**Security Note:** Using `externalIPs` requires that those IPs actually route to your nodes. Kubernetes does not validate this, so misconfiguration can lead to unreachable services.
</Alert>
