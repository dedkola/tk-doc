...
```bash copy
curl -sfL https://get.k3s.io | INSTALL_K3S_VERSION=v1.26.7+k3s1 INSTALL_K3S_EXEC="agent --server https://192.168.3.2:6443 --node-ip 192.168.3.3 --node-external-ip 192.168.3.3" /
K3S_TOKEN=YOUR-K3S-TOKEN K3S_NODE_NAME=agent sh -
```
