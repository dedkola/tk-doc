...
**Security Note**: For production environments, use strong passwords and consider using Kubernetes Secrets management solutions like HashiCorp Vault, Sealed Secrets, or External Secrets Operator.
</Alert>
