...
<Alert type="warning">
  **Security Note:** Exposing the Kubernetes API server to a network increases
  the attack surface. Ensure you have proper firewall rules in place and
  consider using a VPN or SSH tunnel for production environments.
</Alert>
...
<Alert type="warning">**Important Security Considerations:**</Alert>
